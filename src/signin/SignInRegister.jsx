                            ...
                            <div className="w-full h-full relative flex justify-center items-center">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <input
                                            className="justify-self-center w-full flex items-center duration-200 justify-center sm:block bg-yellow-500 hover:bg-yellow-600 py-3.5 px-32 text-white rounded-lg mt-8 sm:mt-10 hover:cursor-pointer"
                                            type="submit"
                                            value="Next"
                                        />
