    ...
    try {
        ...
        if (response.status === 200) {
            ...
            if (data?.company_info && data?.company_name && data?.products_services && data?.industry) {
                ...
                localStorage.setItem("webData", JSON.stringify({ company_info: data.company_info, products_services: data.products_services }));
                ...
                try {
                    ...
                    localStorage.setItem("webData", JSON.stringify({ text: data.text, links: data.links }));
                } catch (parseError) {
    ...
    <div className="w-full min-h-screen flex items-center justify-center">
      ...
      <div className="flex ">
        ...
        >
          ...
          <h3 className="text-center sm:text-start w-fit text-3xl lg:text-[40px] font-medium pb-2 md:px-12 mb-4 font-bold text-black/70">
            Sign up
          </h3>
          ...
          >
            <div className="grid w-full grid-cols-1">
              <div className="flex flex-col w-full">
                ...
                <input
                  placeholder="businessmail@example.com"
